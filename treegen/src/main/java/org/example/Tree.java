...
public class Tree implements Cloneable{
     ...
     public List<Node>  activities =new ArrayList<>();
        ...
        public void examineParallelism2(Node N)
        {
            if(N.type.equals(Type.Sequence))
            {
                ...
                for(int i=0;i<pairings;i++)
                {
                    ...
                    //if(two.getParent()==one.getParent())
                    //{
                      //  System.out.print("Same Parent");
                        //two.getParent().setType(Type.AND);
                        //continue;
                    //}
                    ...
                    if(cost_new<cost_old)
                    {
                        ...
                        {
                         //resulting_neighbors = orderValidity(N.neighbors,constraints,one);  
                        }
        ...
        public boolean pairValidity(Node one_node, Node two_node)
        {
                ...
                for(int i=0;i<precedence.size();i++)
                {
                    ...
                    while(it.hasNext())
                    {
                        ...
                        if(next_check.type==Type.Leaf)
                        {
                         ...
                         {
                          //System.out.println("pair not eligible");
                          // System.out.println(one_node.Name + ",,,," + next_check.Name);
                          return false;
                    ...
                    while(it.hasNext())
                    {
                        ...
                        else
                        {
                           ...
                           while(it2.hasNext())
                           {
                             ...
                             {
                               //System.out.println("pair not eligible");
                               //System.out.println(next_node.Name + " , " + next_check_second.Name);
                               return false;
            ...
            //System.out.println(two_node.parent.Name);
            return true;
        }
        ...
        public void findSequences()
        {
            ...
            else
            {
               HashMap<Integer,Node> middle_root_neighbors = middle_root.neighbors;
                ...
                {
                   //System.out.println("mpaino edo tote");
